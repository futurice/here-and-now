...
public class PersistentValue<T> extends ReactiveValue<T> {
    ...
    private static final SharedPreferences.OnSharedPreferenceChangeListener sharedPreferencesListener = (sharedPreference, key) -> {
        if(key == null) {
            vv(TAG, "SharedPreference key is null");
            return;
        }
        Log.i(TAG," Shared preference: " + sharedPreference + " " + key);
        ...
        Log.i(TAG,"Value: " + persistentValue);
    ...
    protected void onSharedPreferenceChanged() {
        ...
        Log.i(TAG, "persistentValue type: " + classOfPersistentValue.getClass().getName() + " " + classOfPersistentValue + " " + (classOfPersistentValue == String[].class));
    ...
    public boolean set(@NonNull @nonnull final T value) {
        ...
        final IAltFuture<?, ?> altFuture = persistentValueThreadType.then(() -> {
