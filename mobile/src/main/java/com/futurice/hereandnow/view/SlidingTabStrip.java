...
class SlidingTabStrip extends LinearLayout {
    ...
    SlidingTabStrip(@NonNull final Context context) {
        this(context, null);
    }

    SlidingTabStrip(@NonNull final Context context, @Nullable final AttributeSet attrs) {
        super(context, attrs);
        ...
        final int mDefaultBottomBorderColor = setColorAlpha(themeForegroundColor,
    ...
    void setCustomTabColorizer(@NonNull final SlidingTabLayout.TabColorizer customTabColorizer) {
