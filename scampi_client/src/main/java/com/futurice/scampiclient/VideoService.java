...
public class VideoService extends HereAndNowService<VideoCardVO> {
    ...
    public VideoService(@NonNull @nonnull final ScampiHandler scampiHandler,
        ...
        if (!storageDir.exists()) {
            if (!storageDir.mkdirs()) {
                dd(TAG, "Failed to create storage directory.");
    ...
    public IAltFuture<?, SCAMPIMessage> sendMessageAsync(
            @NonNull @nonnull final Uri video,
    ...
    @nonnull
    @Override
    protected VideoCardVO getValueFieldFromIncomingMessage(@NonNull @nonnull final SCAMPIMessage scampiMessage) throws Exception {
    ...
    protected void addValueFieldToOutgoingMessage(
            ...
            @NonNull @nonnull final VideoCardVO value) {
    ...
    @nonnull
    @Override
    public IAltFuture<?, SCAMPIMessage> sendMessageAsync(@NonNull @nonnull final VideoCardVO val) {
