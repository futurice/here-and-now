...
public class BigScreenControllerService extends HereAndNowService<BigScreenControllerService.Command> {
    ...
    @nonnull
    @Override
    protected Command getValueFieldFromIncomingMessage(@NonNull @nonnull SCAMPIMessage scampiMessage)
            throws Exception {
    ...
    @Override
    protected void addValueFieldToOutgoingMessage(@NonNull @nonnull SCAMPIMessage scampiMessage, @NonNull @nonnull Command value) {
    ...
    @nonnull
    @Override
    public IAltFuture<?, SCAMPIMessage> sendMessageAsync(@NonNull @nonnull Command val) {
