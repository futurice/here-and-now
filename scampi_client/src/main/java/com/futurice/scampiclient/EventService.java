...
public final class EventService extends HereAndNowService<Event> {
    ...
    protected void addValueFieldToOutgoingMessage(
            @NonNull @nonnull final SCAMPIMessage scampiMessage,
            @NonNull @nonnull final Event value) {
    ...
    @NonNull
    @Override
    public IAltFuture<?, SCAMPIMessage> sendMessageAsync(@NonNull @nonnull final Event val) {
        throw new UnsupportedOperationException("Clients cannot publish events.");
    }
    //======================================================================//

    @Override
    protected void notifyMessageExpired(@NonNull @nonnull final String key) {
